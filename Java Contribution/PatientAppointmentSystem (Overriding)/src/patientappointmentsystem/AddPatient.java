...
public class AddPatient extends javax.swing.JFrame {
    ...
    public AddPatient() {
        ...
        id.setText((Integer.valueOf(p.getPatientNewId())).toString());
    ...
    private void initComponents() {
        ...
        jButton2.setText("Check Your Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
        Patient d = new Patient(p.getPatientNewId(), name.getText(), phoneNumber.getText(), email.getText(), Integer.parseInt(age.getText()), password.getText(), cnic.getText(), bloodGroup.getText());
//        System.err.println(p.PatienListList.size());

        p.PatienListList.add(d);
//        System.err.println(p.PatienListList.size());
//        System.err.println(p.PatienListList.size());
        p.savePatients();
